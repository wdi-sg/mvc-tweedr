...
// const allPaymentModelsFunction = require
const allPaymentModelsFunction = require('./models/payments');
const payments = allPaymentModelsFunction(pool);
