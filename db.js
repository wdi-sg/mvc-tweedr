...
const allTweetsModel = require('./models/tweets');
const tweetsModelObject = allTweetsModel(pool);
...
const allFavesModel = require("./models/favourites");
const favesModelObject = allFavesModel(pool);
