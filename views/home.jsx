    ...
    var tweets = this.props.tweedsList.map(tweet =>{
        ...
        return (
            <div className="tweet_box">
                <div>{tweet.tweed} <span>- {tweet.createdby_user}</span></div>
            </div>
    ...
    return (
      <html>
        ...
        <body>
            ...
            <div id="username"><UsernameStatus isLoggedIn={this.props.cookieUserLogin}/>&nbsp;<h3>{this.props.cookieUserName}</h3></div>
