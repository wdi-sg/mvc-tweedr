            ...
            <html>
                ...
                &emsp;Tweedr
                    ...
                    <div className="mt-3 container-fluid bg-dark w-25 d-flex flex-column text-center p-3 border border-secondary rounded-lg">
                        ...
                        <h4 className="text-light">Add New Hashtag</h4>

                        <form className="d-flex flex-column w-75 ml-auto mr-auto" method="POST" action={'/tag'}>
                            <br/>
                            <div className="input-group mb-3">
                                <div className="input-group-prepend">
                                    <span className="input-group-text" id="basic-addon1">#</span>
                                </div>
                                <input type="text" className="form-control" placeholder="Tag Name" name = "hashtag" aria-label="hashtag" aria-describedby="basic-addon1"></input>
                            </div>
                            
                            <input className="btn btn-primary rounded-pill mt-3 mb-3 pt-2 pb-2" type="submit" value="Add Hashtag" />
                        </form>
                    </div>
